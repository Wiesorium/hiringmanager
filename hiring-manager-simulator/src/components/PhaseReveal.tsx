...
export function PhaseReveal() {
    ...
    // Mock "Real Hiring Manager" choice - let's say it was Emily Blunt (c5) - the cheap, high potential one.
    const realManagerChoiceId = 'c5';
    const realManagerChoice = candidates.find(c => c.id === realManagerChoiceId);
            ...
            <div className="text-center space-y-4">
                ...
                >
                    <span className={cn(
                        ...
                        {isSuccess ? "Great Hire" : isFailure ? "Bad Hire" : "Mixed Result"}
                    </span>
                </motion.div>
                <h2 className="text-5xl font-serif font-bold">
                    You hired {chosenCandidate.name}
                </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                    <h3 className="text-xl font-bold font-serif mb-6 flex items-center gap-2">
                        <div className="w-8 h-8 bg-ink text-white rounded-full flex items-center justify-center text-sm">You</div>
                        The Outcome
                    </h3>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-stone-50 p-4 rounded border border-stone-100">
                            <h5 className="text-xs font-bold uppercase tracking-wider text-muted mb-3">6 Months Later</h5>
                ...
                >
                    ...
                    <h3 className="text-xl font-bold font-serif mb-6 flex items-center gap-2">
                        ...
                        The Real Hiring Manager
                    </h3>

                    <div className="space-y-6 relative z-10">
                        <div>
                            <p className="text-sm text-muted mb-1">They chose:</p>
                            ...
                            <p className="text-ink/80 leading-relaxed font-serif italic text-lg">
                                "I went with Emily (Candidate 5). She was inexperienced, but she had the hunger and the writing skills we needed. It was a gamble that paid off—she's now our Director of Marketing."
                            </p>
                        </div>

                        <div className="pt-6 border-t border-stone-200">
                            <h5 className="text-xs font-bold uppercase tracking-wider text-muted mb-3">Community Stats</h5>
                            <div className="space-y-3">
                                ...
                                <StatBar label="Others" percentage={25} />
                            </div>
                        </div>
                    </div>
                </motion.div>
        ...
        <div>
            <div className="flex justify-between text-xs mb-1">
                <span className="font-medium flex gap-2">
                    {label}
                    {isYou && <span className="text-highlight font-bold">(You)</span>}
                    {isWinner && <span className="text-emerald-600 font-bold">(Real Pick)</span>}
                </span>
